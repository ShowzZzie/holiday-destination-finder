"""Airport and country data for origin expansion."""
...
COUNTRIES: list[Country] = [
    {
        ...
        "kgmid": "/m/05qhw",
        "airports": [
            {"iata": "WRO", "name": "Wroclaw Nicolaus Copernicus Airport", "city": "Wroclaw", "city_kgmid": "/m/0861k"},
            ...
            {"iata": "KRK", "name": "John Paul II International Airport Krakow-Balice", "city": "Krakow", "city_kgmid": "/m/0491p"},
            {"iata": "GDN", "name": "Gdansk Lech Walesa Airport", "city": "Gdansk", "city_kgmid": "/m/0339v"},
            {"iata": "POZ", "name": "Poznan-Lawica Airport", "city": "Poznan", "city_kgmid": "/m/064_n"},
        ],
    },
    {
        "name": "United Kingdom",
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "DUS", "name": "Dusseldorf Airport", "city": "Dusseldorf", "city_kgmid": "/m/02h6f"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "AGP", "name": "Malaga-Costa del Sol Airport", "city": "Malaga", "city_kgmid": "/m/0fsz5"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "NCE", "name": "Nice Cote d'Azur Airport", "city": "Nice", "city_kgmid": "/m/05mzf"},
            {"iata": "LYS", "name": "Lyon-Saint Exupery Airport", "city": "Lyon", "city_kgmid": "/m/04ks6"},
            ...
            {"iata": "BOD", "name": "Bordeaux-Merignac Airport", "city": "Bordeaux", "city_kgmid": "/m/01m26"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "BRI", "name": "Bari Karol Wojtyla Airport", "city": "Bari", "city_kgmid": "/m/01f6h"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "OPO", "name": "Francisco de Sa Carneiro Airport", "city": "Porto", "city_kgmid": "/m/060sc"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "SAW", "name": "Istanbul Sabiha Gokcen Airport", "city": "Istanbul", "city_kgmid": "/m/09942"},
            {"iata": "AYT", "name": "Antalya Airport", "city": "Antalya", "city_kgmid": "/m/01pfx"},
            {"iata": "ADB", "name": "Izmir Adnan Menderes Airport", "city": "Izmir", "city_kgmid": "/m/042_m"},
    ...
    },
    {
        ...
        "airports": [
            ...
            {"iata": "TOS", "name": "Tromso Airport", "city": "Tromso", "city_kgmid": "/m/07f4p"},
        ],
    },
    {
        "name": "Sweden",
        ...
        "airports": [
            ...
            {"iata": "MMX", "name": "Malmo Airport", "city": "Malmo", "city_kgmid": "/m/0529k"},
        ],
    },
    {
        "name": "Ireland",
    ...
    },
    {
        ...
        "kgmid": "/m/01sk",
        "airports": [
            {"iata": "PRG", "name": "Vaclav Havel Airport Prague", "city": "Prague", "city_kgmid": "/m/05ygk"},
            {"iata": "BRQ", "name": "Brno-Turany Airport", "city": "Brno", "city_kgmid": "/m/01f_8"},
        ],
    },
    {
        "name": "Hungary",
    ...
    },
    {
        ...
        "kgmid": "/m/068x",
        "airports": [
            {"iata": "OTP", "name": "Henri Coanda International Airport", "city": "Bucharest", "city_kgmid": "/m/01f6j"},
...
def expand_origin_to_airports(origin: str) -> list[str]:
    """
    Expand a kgmid (country or city) to a list of IATA airport codes.
    If origin is already an IATA code, returns it as a single-element list.

    Args:
        origin: Either a 3-letter IATA code or a kgmid starting with /m/ or /g/
    ...
    for country in COUNTRIES:
        if country["kgmid"] == origin:
            return [airport["iata"] for airport in country["airports"]]

    # Check if it's a city kgmid
    airports = []
    for country in COUNTRIES:
        for airport in country["airports"]:
            if airport.get("city_kgmid") == origin:
                airports.append(airport["iata"])

    if airports:
        return airports

    # Unknown kgmid - return empty list
    return []


def get_origin_display_name(origin: str) -> str:
    """Get human-readable name for an origin."""
    if not origin.startswith('/'):
        # It's an IATA code - find the airport name
        for country in COUNTRIES:
            for airport in country["airports"]:
                if airport["iata"] == origin.upper():
    ...
    for country in COUNTRIES:
        for airport in country["airports"]:
            if airport.get("city_kgmid") == origin:
                return f"{airport['city']} ({country['name']})"
